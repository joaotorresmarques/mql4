//+------------------------------------------------------------------+
//|                                                   EA MA_RSI.mq4  |
//|                                    Copyright @2013, Hua Ai (aha) |
//|                                                                  |
//| 11/15/06 - Robert Hill - added magic number                      |
//+------------------------------------------------------------------+
...
*/               
               ticket=OrderSend(Symbol(),OP_BUY,TotalLots,Ask,3,Ask-HardStopLoss*Point,0,"Bago",MagicNumber,0,Green);
...
*/       
               ticket=OrderSend(Symbol(),OP_SELL,TotalLots,Bid,3,Bid+HardStopLoss*Point,0,"Sidus",MagicNumber,0,Red);
