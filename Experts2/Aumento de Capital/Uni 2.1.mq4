...
//=========================CONFIGURA플O DE LOTE    
   switch(count) 
   {
      ...
      case 4: iLots = 0.12; break;
      case 5: iLots = 0.14; break;
      case 6: iLots = 0.18; break;
      case 7: iLots = 0.22; break;
      case 8: iLots = 0.24; break;
      case 9: iLots = 0.28; break;
      case 10: iLots = 0.32; break;
   }
...
//=========================CONFIGURA플O DE LOTE MAGIC2    
   switch(count2) 
   {
      ...
      if(count2>=10) iLots = count2*0.06;          
      
//=========================CONFIGURA플O DE TAKES   
    switch(countsell) 
   {
      case 0: takeSELL = TrallingStop;       break;
      case 1: takeSELL = TrallingStop+4; break;
      case 2: takeSELL = TrallingStop+4; break;
      case 3: takeSELL = TrallingStop+6; break;
      case 4: takeSELL = TrallingStop+6; break;
      case 5: takeSELL = TrallingStop+8; break;
      case 6: takeSELL = TrallingStop+9; break;
      case 7: takeSELL = TrallingStop+9; break;
      case 8: takeSELL = TrallingStop+9; break;
      case 9: takeSELL = TrallingStop+15; break;
   } 
   if(count >= 10) takeSELL = TrallingStop+count+9;
   
    switch(countbuy) 
   {
      case 0: takeBUY = TrallingStop;       break;
      case 1: takeBUY = TrallingStop+4; break;
      case 2: takeBUY = TrallingStop+4; break;
      case 3: takeBUY = TrallingStop+6; break;
      case 4: takeBUY = TrallingStop+6; break;
      case 5: takeBUY = TrallingStop+8; break;
      case 6: takeBUY = TrallingStop+9; break;
      case 7: takeBUY = TrallingStop+9; break;
      case 8: takeBUY = TrallingStop+9; break;
      case 9: takeBUY = TrallingStop+15; break;
   } 
   if(count >= 10) takeBUY = TrallingStop+count+9;   
...
//=========================CONFIGURA플O DE TAKES MAGIC2   
    switch(countsell2) 
   {
      ...
      case 1: takeSELL2 = TrallingStop+count2; break;
      case 2: takeSELL2 = TrallingStop+count2; break;
      case 3: takeSELL2 = TrallingStop+count2; break;
      case 4: takeSELL2 = TrallingStop+count2; break;
      case 5: takeSELL2 = TrallingStop+count2; break;
      case 6: takeSELL2 = TrallingStop+count2; break;
      case 7: takeSELL2 = TrallingStop+count2; break;
      case 8: takeSELL2 = TrallingStop+count2; break;
      case 9: takeSELL2 = TrallingStop+count2; break;
   } 
   if(count2 >= 10) takeSELL2 = TrallingStop+count;
   
    switch(countbuy2) 
   {
      case 0: takeBUY2 = TrallingStop;       break;
      case 1: takeBUY2 = TrallingStop+count2; break;
      case 2: takeBUY2 = TrallingStop+count2; break;
      case 3: takeBUY2 = TrallingStop+count2; break;
      case 4: takeBUY2 = TrallingStop+count2; break;
      case 5: takeBUY2 = TrallingStop+count2; break;
      case 6: takeBUY2 = TrallingStop+count2; break;
      case 7: takeBUY2 = TrallingStop+count2; break;
      case 8: takeBUY2 = TrallingStop+count2; break;
      case 9: takeBUY2 = TrallingStop+count2; break;
   } 
   if(count2 >= 10) takeBUY2 = TrallingStop+count2;      
         ...
         if(MA4+3*MyPoint<MA21 && MA21<MA50)    ordemsell = OrderSend(Symbol(),OP_SELL,Lots,Bid,Slippage,0,0,Robo,MagicNumber,0,Red);
            ...
            {  
               if(countbuy>=1)
               {
                  if(OrderType()==OP_BUY)
                  { 
                     if(Ask+StopLoss*MyPoint<OrderOpenPrice()) ordembuy = OrderSend(Symbol(),OP_BUY,iLots,Ask,Slippage,0,0,Robo,MagicNumber,0,clrGreenYellow);
            ...
            {  
               if(countsell>=1)
               {
                  if(OrderType()==OP_SELL)
                  {
                     if(Bid-StopLoss*MyPoint>OrderOpenPrice()) ordemsell = OrderSend(Symbol(),OP_SELL,iLots,Bid,Slippage,0,0,Robo,MagicNumber,0,clrGreenYellow);
