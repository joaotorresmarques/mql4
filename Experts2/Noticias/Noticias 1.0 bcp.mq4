         ...
         {  
               if(OrderType()==OP_BUY)
               {
                ...
                if(OrderType()==OP_SELL)
                {
                  ...
                  if(SLsell==0 && OrderClosePrice()+Tralling*MyPoint<stnewpricesell) ticket = OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()-(Tralling-4)*MyPoint,0,0,clrLightGreen);
                  
                  if(SLsell>0 && (Ask<OrderStopLoss()-stepTralling*MyPoint))  ticket = OrderModify(OrderTicket(),OrderOpenPrice(),OrderStopLoss()-(stepTralling-4)*MyPoint,0,0,clrLightGreen);
               }//FIM OP_SELL
