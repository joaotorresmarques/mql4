...
/*=======================================================ANOTAÇÕES========================================================
Correção da versão 2.1.  precisamente no MAGIC4

No KV S MOD quando a MAGIC4 é lançada se o preço recuar nenhuma ordem é stopada. Todas as ordens são fechadas 
quando MAGIC4 dar TAKE.

OPINIÃO: O EA esta se comportando muito bem! Porém quando o MAGIC4 é ativado ele perde muito, más recupera. Corro o risco de zerar a banca.
Na versão 2.3 tentarei fazer com que todas as ordens sejam finalizadas quando o MAGIC4 der take.

**Não consegui fazer como na "opinião". Não consegui com programação e minha cabeça ta me dizendo pra continuar com o 2.2
