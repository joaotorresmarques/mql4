...
input double maxLots1 = 0.1; 
input double maxLots2 = 0.2;
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ABERTURA ORDEM++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++       
   ...
   if(OrdersTotal()==0)
   {
      if(Bid+5*MyPoint<=MA)  ticket = OrderSend(Symbol(),OP_SELL,Lots1,Bid,0,0,Bid-TAKE1*MyPoint,Robo,MagicNumber1,0,Red); 
        
      if(Ask-5*MyPoint>=MA)   ticket = OrderSend(Symbol(),OP_BUY,Lots1,Ask,0,0,Ask+TAKE1*MyPoint,Robo,MagicNumber1,0,Blue); 
   }
  }//FIM ORDERSTOTAL
