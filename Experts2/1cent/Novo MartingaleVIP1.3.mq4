...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ABERTURA ORDEM++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
  if(TimeCurrent()>espera)
  {
    if(countbuy==0 && countbuystop==0)
    {
      ...
      {
         ticket = OrderSend(Symbol(), OP_BUYSTOP,Lots, High[0]+DistancePips*MyPoint,Slippage,0,0,NULL,MagicNumber,0,Blue); 
      }
    ...
    if(countsell==0 && countsellstop==0)
    {
      ...
      {
          ticket = OrderSend(Symbol(),OP_SELLSTOP,Lots,Open[0]-DistancePips*MyPoint,Slippage,0,0,NULL,MagicNumber2,0,Red);
      }
...
//=========================CONFIGURAÇÃO DE TAKES   
    switch(countsell) 
   {
      ...
      case 5: takeSELL = TakeProfitMartingale*1; break;
      case 6: takeSELL = TakeProfitMartingale*1; break;
      case 7: takeSELL = TakeProfitMartingale*2; break;
      case 8: takeSELL = TakeProfitMartingale*2; break;
      case 9: takeSELL = TakeProfitMartingale*2; break;
    ...
    switch(countbuy) 
   {
      ...
      case 4: takeBUY = TakeProfitMartingale*1; break;
      ...
      case 8: takeBUY = TakeProfitMartingale*2; break;
      case 9: takeBUY = TakeProfitMartingale*2; break;
      
      case 0: takeBUY = TakeProfit; break;
   } 
   if(countsell >= 10) takeBUY = TakeProfitMartingale*3;
